...
abstract final class AppColors {
  ...
  // Dark
  static const backgroundDark = Color(0xFF0E1112);
  static const surfaceDark = Color(0xFF171C1F);
  ...
  //static const brandSoft = Color(0xFFD9F3EE);
  static const brand = Color(0xFF178F84);
  static const brandDark = Color(0xFF5EDBCB);
  static const brandSoft = Color(0xFFD9F3EE);
  static const brandSoftDark = Color(0xFF153A37);

  // Status
  static const success = Color(0xFF12B76A);
  static const warning = Color(0xFFF5B942);
  static const error = Color(0xFFE86A6A);
}
